...
* The disturbance modules (bark beetle + wind; black line in baseline facet) killed more basal area than our reference disturbance regime (maybe because our assumed severity of 90% of susceptible trees is too low as wind events usually have higher severities?):
...
* The wind module (black line in baseline facet) killed about the same amount of basal area as our reference disturbance regime:
...
>
> Structure changes very quickly for the disturbance modification scenarios, for the baseline disturbance scenarios it decreases linearly and quicker for hot-dry climate, lowest value ~0%
>
> Composition decreases more in the first half of the centuy and then stays relatively stable, more change under baseline climate, lowest value ~60%
>
> Basically all forest lost by end of century for the disturbance modification scenarios, under baseline disturbances slow decrease, higher under hot-dry climate, lowest value ~1 %
>
...
>  
> All processes (disturbance, regeneration, climate) seem to have an impact on forest loss but especially disturbance size and frequency
> 
...
1. Structure: high probability of change pretty much everywhere, especially under hot-dry climate (left)
...
* Basal area varied strongly across different disturbance modification scenarios but only differed slightly between baseline and hot-dry climate (Dotted red line: simulation with disturbances simulated via modules instead of management):


![](results/figures/landscapeWide_basalArea_overTime_grte.png)


* Basal area consistently dropped below the 2020-value in 2100. Basal area drops super low under the disturbance modification scenarios:
...
* Under the extreme process modification scenario *Populus tremula* and *Pseudotsuga menziensii glauca* increased at the detriment of *Pinus contorta*:
...
* Closer look at *Pinus contorta*, the originally dominant species: its proportion really remains fairly stable under baseline and hot-dry climate. Different disturbance modification scenarios had different impacts on its abundance (Dotted red line: simulation with disturbances simulated via modules instead of management)
...
* The bite and fire modules (black line in baseline facet) killed about the same amount of basal area as our reference disturbance regime. Basal area killed decreased under the disturbance modification scenarios as less were available for killing:


![](results/figures/landscapeWide_treesKilled_grte.png)


* Basal area killed was very similar under baseline and hot-dry climate: 

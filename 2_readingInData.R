...
## server: Lorien
## saving data to: E:\ 
## landscape(s) running: all
## landscape(s) finished and saved: all (06.07.24, 6:30 am)
## misc: without dynamicstand (mainly for patch.df + regen.df)
...
# patchlist[duplicated(patchlist[,1:7]),]
